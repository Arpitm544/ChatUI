...
const ChatSidebar = ({
  ...
  return (
    <div className="w-1/4 bg-white shadow p-4 overflow-y-auto flex flex-col">
      ...
      <p className="text-sm text-gray-500 mb-2">Logged in as: {me}</p>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {groups.length > 0 && (
          <div className="mb-4">
            <h3 className="font-semibold text-gray-600 mb-2">Groups</h3>
            {groups.map((g) => (
              <div
                key={g._id}
